...
const Resume = () => {
  return (
    <div className="min-h-screen bg-gray-600 flex flex-col p-4 md:p-6 lg:p-8 md:rounded-xl md:m-7">
      <Navbar />
      <div className="mt-6 md:mt-8 text-white flex-1">
        ...
        <div className="min-h-[calc(100vh-12rem)] w-full rounded-2xl bg-white shadow-xl overflow-hidden flex flex-col">
          {/* Header */}
          <div className="bg-gradient-to-r from-teal-500 to-cyan-600 p-4 sm:p-6 md:p-8 lg:p-10 text-white relative flex-shrink-0">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl mt-2 font-light tracking-wider">
                Frontend Developer
              </p>
              <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row justify-center space-y-2 sm:space-y-0 sm:space-x-4 md:space-x-6 text-xs sm:text-sm md:text-base lg:text-lg">
                <a
            ...
            <div className="space-y-6 md:space-y-8 md:col-span-1">
              ...
              <div>
                ...
                <div className="mt-3 text-gray-600 text-xs sm:text-sm md:text-base">
                  ...
                  <p>
                    <span className="font-medium">English:</span> A1
                  </p>
                  <p>
                    <span className="font-medium">Russian:</span> B2
                  </p>
                  <p>
                    <span className="font-medium">Uzbek:</span> Native Speaker
                    (NS)
                  </p>
                </div>
              </div>
                ...
                <div className="mt-4 space-y-4 md:space-y-6">
                  <div>
                    ...
                    <ul className="mt-2 text-gray-600 text-xs sm:text-sm md:text-base list-disc list-inside">
                      <li>Developed complex web applications using React.</li>
                      <li>
